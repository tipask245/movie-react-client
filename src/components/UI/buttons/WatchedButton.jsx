...
const WatchedButton = (props, {styles}) => {
  
  return (
    <div className={classes.button_wrap}>
      <button {...props} className={classes.watched_button}>
        <svg {...styles} width="40" height="24" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
